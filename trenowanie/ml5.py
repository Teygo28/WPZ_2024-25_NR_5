...
try:
    joblib.dump(model, 'D:/Marcin/ML/modele/ml_3.pkl')
...
def predict_letter(image_path):
    ...
    # Wczytanie modelu
    model = joblib.load('D:/Marcin/ML/modele/letter_recognition_model.pkl')
...
image_path = 'D:/Marcin/ML/img/a1.png'  # Ścieżka do obrazka 28x28 px
